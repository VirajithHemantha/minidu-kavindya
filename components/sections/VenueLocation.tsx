        ...
        <div className="grid grid-cols-1 items-stretch gap-5 lg:grid-cols-12 lg:gap-8">
          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white/95 to-transparent p-4 pt-16 sm:p-6 md:p-8">
              ...
              >
                <div>
                  <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#be7f56]">Hotel Location</p>
                  <h4 className="mt-1 font-serif text-lg text-[#4d3732] sm:text-2xl">Golden Flower Hotel</h4>
                </div>
          ...
          >
            <div className="h-full rounded-[2rem] border border-[#f1dcc5] bg-[linear-gradient(180deg,rgba(255,255,255,0.78)_0%,rgba(255,245,232,0.8)_100%)] p-6 shadow-[0_16px_45px_rgba(183,127,92,0.14)] backdrop-blur-xl md:p-7">
              ...
              <h3 className="font-serif text-3xl leading-tight text-[#4d3732] md:text-4xl">
                Golden Flower<br />Hotel
              </h3>

              <p className="mt-5 text-sm leading-relaxed text-[#7a6258] md:text-base">
                We warmly invite you to join us at Golden Flower Hotel, Hingurakgoda to celebrate our wedding on July 04, 2026.
              </p>

              <div className="mt-6 rounded-2xl border border-[#ead2b9]/60 bg-white/75 p-4">
                <p className="text-[10px] uppercase tracking-[0.2em] text-[#b78058]">Address</p>
                <p className="mt-2 text-sm font-medium text-[#4d3732]">Airport Road, Hingurakgoda</p>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#ca7c57] px-5 py-3 text-xs font-bold uppercase tracking-[0.2em] text-white shadow-[0_12px_28px_rgba(183,109,72,0.35)] transition-transform hover:scale-[1.02]"
              >
                Open Location Map
