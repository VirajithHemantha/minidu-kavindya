...
const storyItems = [
  {
    ...
    content: "Our love story began in school, where a simple connection blossomed into something profound. What started as friendship slowly grew into deep love, trust, and a lifelong bond.",
    icon: Stars,
    color: "#ff4d6d",
  ...
  },
  {
    id: 1,
    chapter: "Chapter II",
    title: "Higher Education Together",
    subtitle: "Growing Side by Side",
    content: "We pursued our education together, supporting and inspiring each other through every challenge. Those years shaped us into who we are today, building a stronger foundation for our love.",
    icon: BookHeart,
    color: "#c084fc",
